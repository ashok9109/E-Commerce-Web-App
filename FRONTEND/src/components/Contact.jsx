    ...
    return (
        <section className='min-h-screen w-full bg-background flex flex-col items-center justify-center'>
            ...
            <div className='h-full w-full max-w-3xl p-6'>
                ...
                <h1 className='font-bold' >Whatsapp :- 91-6268226160</h1>
                <h1 className='font-bold' >Email :- support@upstareresearch.com</h1>
                </div>

                {/* contact form */}
                <form className='w-full flex flex-col gap-8 mt-6'>
                    <h1 className='text-3xl text-center font-bold text-[#F1E99D]' >Contact Us Form</h1>
                    <input className='w-full bg-white p-3 rounded-lg' placeholder='Name' type="text" />
                    <input className='w-full bg-white p-3 rounded-lg' placeholder='Email' type="email" />
                    <textarea className='w-full bg-white p-3 rounded-lg' ></textarea>
